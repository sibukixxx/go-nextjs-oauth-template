  ...
  useEffect(() => {
    const processCallback = async () => {
      try {
        ...
        if (errorParam) {
          throw new Error(errorDescription || `LINE login error: ${errorParam}`)
        }
          ...
          {status === 'processing' && (
            <>
              <div className="mb-4 flex justify-center">
                <svg
                  className="h-12 w-12 animate-spin text-[#06C755]"
                  viewBox="0 0 24 24"
                  fill="none"
                >
                  <circle
              ...
              <h2 className="text-lg font-medium">Authenticating with LINE...</h2>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="rounded-xl border border-[var(--muted)] bg-[var(--background)] p-8 text-center shadow-sm">
          <div className="mb-4 flex justify-center">
            <svg className="h-12 w-12 animate-spin text-[#06C755]" viewBox="0 0 24 24" fill="none">
              <circle
                className="opacity-25"
                cx="12"
                cy="12"
